...
INSERT INTO `barang` VALUES ('A10','Mouse',30),('A11','Keyboard',15),('A12','DVD R-W',10),('A13','Modem',10);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER auditBarang
...
CREATE TABLE `pembelian` (
  ...
  PRIMARY KEY (`id_pem`),
  KEY `id_brg` (`id_brg`),
  CONSTRAINT `pembelian_ibfk_1` FOREIGN KEY (`id_brg`) REFERENCES `barang` (`id_brg`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pembelian` VALUES (1,'A13',4),(2,'A10',10),(3,'A10',20);
...
-- Dump completed on 2026-06-17  0:40:17
